...
import br.com.urbanproblems.extensions.showShortSnack
...
class MyProfileActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (ImagePicker.shouldHandle(requestCode, resultCode, data)) {
            ...
            br.com.urbanproblems.MyApp.user!!.avatar = image.path
            myProfileViewModel.saveUserProfile(br.com.urbanproblems.MyApp.user!!)
    ...
    private fun fillUserData() {
        ...
        tvFullname.text = br.com.urbanproblems.MyApp.user!!.name
        tvEmail.text = br.com.urbanproblems.MyApp.user!!.email
        tvDateRegistration.text = br.com.urbanproblems.MyApp.user!!.dateRegister
        if (!br.com.urbanproblems.MyApp.user!!.avatar.isEmpty()) {
            Glide.with(this).load(br.com.urbanproblems.MyApp.user!!.avatar).into(ivMyProfile)
        } else {
